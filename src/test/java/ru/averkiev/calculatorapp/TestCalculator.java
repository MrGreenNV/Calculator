...
public class TestCalculator {
    ...
    void outExceptionDivisionByZero() {
        Throwable thrown1 = assertThrows(ArithmeticException.class, () -> {
            calculator.division(2, 2, 0);
        });
        assertEquals(thrown1.getMessage(), "Division by zero is prohibited!");

        Throwable thrown2 = assertThrows(ArithmeticException.class, () -> {
            calculator.division(2, 0, 4);
        });
        assertEquals(thrown2.getMessage(), "Division by zero is prohibited!");

        Throwable thrown3 = assertThrows(ArithmeticException.class, () -> {
